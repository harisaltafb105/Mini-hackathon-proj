...
<h2 className="font-bold text-3xl text-center underline"> Suzuki Alto 2024 Price in Pakistan, Images, Reviews & Specs </h2>
</div>

<div className=" w-4/12 ">
    <Link href="/cardetail02"><img src="/Suzuki-alto.jpg"/></Link>
</div>
...
<p className="text-green-500 font-semibold text-lg text-center  "> PKR 20,00,000 </p>
