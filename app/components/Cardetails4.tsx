...
export default function Cardetails4(){
...
<div className=" w-4/12 ">
    <img src="/Hondacivic.jpg"/>
</div>

<div className=" w-9/12 text-sm text-center ">
   <Link href="/cardetail04"> <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vitae accusantium ad dignissimos perspiciatis dicta dolorem quaerat praesentium nobis placeat similique voluptatem architecto mollitia, aliquam nemo cupiditate cumque. Minima, error illo.
...
<p className="text-green-500 font-semibold text-lg text-center  "> PKR 80,00,000 </p>
